          ...
          <div className="rating">
            ...
            >
              ...
              <a className="rating-item">
                ...
                <p className="rating-description">
                  I am a complete beginner and just started exploring Binance
                  Academy. Let me test my basic knowledge.
                </p>
              </a>
            </Link>
            <Link
            ...
            >
              ...
              <a className="rating-item">
                ...
                <h3>intermediate</h3>
                <p className="rating-description">
                  I am a frequent visitor of Binance Academy and am quite
                  familiar with some terms, but still on my path to true
                  knowledge.
                </p>
              </a>
            </Link>
            ...
            >
              ...
              <a className="rating-item">
                ...
                <h3>advanced</h3>
                <p className="rating-description">
                  I have learned enough at Binance Academy. My knowledge base is
                  wide and I feel ready to be challenged.
                </p>
              </a>
            </Link>
          </div>
